        ...
        <View style={styles.content}>
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.description}>
              Thank you for joining SkinHealth! We're putting the finishing touches on amazing features that will revolutionize your skincare routine.
            </Text>
            ...
            <View style={styles.featuresContainer}>
              ...
              <View style={styles.featureItem}>
                <View style={styles.bullet} />
                <Text style={styles.featureText}>Personalized skincare routines</Text>
              </View>
